...
<link rel="stylesheet" href="{{asset('css/bootstrap.min.css')}}">
    <div class="container p-3">
        <h2>Détails des Clients Confirmes</h2>
            ...
            <div class="card mb-4 shadow">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <form action="{{ url('envoyercommande', $client->id) }}" method="POST" >
                                @csrf
                                <button type="submit" class="btn btn-success">Envoyer Commande</button>
                            </form>
                        </div>
                    </div>
